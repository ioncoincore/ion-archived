...
// ion includes.
#include <..\src\script\ionconsensus.h>
...
int main()
{
    std::cout << "ionconsensus version: " << ionconsensus_version() << std::endl;
    ...
    ionconsensus_error err;
    auto op0Result = ionconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, ionconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
