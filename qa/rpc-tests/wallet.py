...
#   c) node1 mines 32 blocks, so now node 0 has 60001ion, node 1 has 4250ion, node2 has none.
#   d) node0 sends 601 ion to node2, in two transactions (301 ion, then 300 ion).
